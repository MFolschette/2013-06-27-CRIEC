...
\newcommand{\thedate}{2013/06/19}
\date{\thedate}
\conference{English presentation}{--- Module professionnel ---\\Anglais pour la recherche}
\title[The Process Hitting framework]{The Process Hitting framework:\\An algebraic Bio-informatics modelling}
